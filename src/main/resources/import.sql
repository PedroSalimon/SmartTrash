...
insert into tb_lixo_espacial (risco, tipo, data_ultima_aparicao, peso, id_colisao) values ('Baixo', 'SATELITE', '2026-05-31', 0.5, 1)
insert into tb_lixo_espacial (risco, tipo, data_ultima_aparicao, peso, id_colisao) values ('Alto', 'FRAGMENTO', '2026-05-31', 5000, 2)
insert into tb_lixo_espacial (risco, tipo, data_ultima_aparicao, peso, id_colisao) values ('Baixo', 'SATELITE', '2026-05-31', 3, 3)
insert into tb_lixo_espacial (risco, tipo, data_ultima_aparicao, peso, id_colisao) values ('Médio', 'FOGUETE', '2026-05-31', 4, 4)
